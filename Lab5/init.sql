DROP DATABASE IF EXISTS sawm_lab5;
CREATE DATABASE sawm_lab5 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE sawm_lab5;
...
FROM role r
JOIN permission p
WHERE (r.code = 'administrator' AND p.code IN ('panel.admin'))
